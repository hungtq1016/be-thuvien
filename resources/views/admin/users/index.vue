<template>
   <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center dark:bg-zinc-700 rounded-md p-3">
      <div class="sm:flex-auto ">
        <h1 class="text-xl font-semibold dark:text-white py-3  ">Users</h1>
        <p class="mt-2 text-sm dark:text-white">A list of all the users in your account including their name, title, email and role.</p>
      </div>
