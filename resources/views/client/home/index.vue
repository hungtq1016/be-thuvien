<template>
    <div class="bg-white">
        ...
        <!-- Overlapping cards -->
        <!-- <section
            class="relative z-10 mx-auto max-w-7xl px-6 pb-32 lg:px-8"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8"
                    >
                        <a
                            :href="link.href"
        ...
        <section>
            <div
                class="relative bg-gray-50 px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28"
            >
                ...
                <div class="relative mx-auto max-w-7xl">
                    ...
                    <div
                        class="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-4"
                    >
                        <div
                            v-for="post in posts"
                            :key="post.title"
